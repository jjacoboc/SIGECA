...
<html:html>
    ...
    <body>
        <html:form action="nuevoUsoBC-action" method="post" >
            <table width="750" align="center" cellPadding="0" cellSpacing="0" class="clsTabla2">
                <tr>
                    <td class="Titulo1">NUEVO USO BC</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                                ...
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="clsTabla2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="casilla" name="codigoUsoBC" id="codigoUsoBC" value="" size="6" maxlength="6" onkeypress="return valida(this,'int');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="etiqueta" height="24">&nbsp;&nbsp;&nbsp;DESCRIPCI&Oacute;N USO BC</td>
                                            <td>
                                                <input type="text" class="casillaLarga" name="descripcionUsoBC" id="descripcionUsoBC" value="" maxlength="250" onkeypress="return valida(this,'afn');" onkeyup="this.value=this.value.toUpperCase()" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
