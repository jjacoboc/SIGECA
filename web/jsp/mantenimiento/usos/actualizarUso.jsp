...
<html:html>
    ...
    <body>
        <html:form action="actualizarUso-action" method="post" >
            <table width="750" align="center" cellPadding="0" cellSpacing="0" class="clsTabla2">
                <tr>
                    <td class="Titulo1">ACTUALIZAR USO</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                        ...
                        <table width="90%" align="center" cellPadding="0" cellSpacing="0">
                                ...
                                <td>
                                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="clsTabla2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String codigoUso = (String)session.getAttribute("codigoUso");
                                                    codigoUso = codigoUso==null? "": codigoUso;
                                                %>
                                                <input type="text" class="casilla" name="codigoUso" id="codigoUso" value="<%=codigoUso%>" size="6" maxlength="6" onkeypress="return valida(this,'int');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String descripcionUso = (String)session.getAttribute("descripcionUso");
                                                    descripcionUso = descripcionUso==null? "": descripcionUso.trim();
                                                %>
                                                <input type="text" class="casillaLarga" name="descripcionUso" id="descripcionUso" value="<%=descripcionUso%>" maxlength="250" onkeypress="return valida(this,'afn');" onkeyup="this.value=this.value.toUpperCase()" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="3" align="center">
                                    ...
                                    <input class="buttoncenter" type="button" value="Eliminar" name="bEliminar" onclick="JavaScript:eliminarUso();"/>
