...
<html:html>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function eliminarHabUrba()
        {
            if (confirm("Desea eliminar el registro"))
            {
                f = document.forms[0];
                f.method.value = 'eliminarHabUrba';
                f.submit();
            }
        }
        function cancelar()
    ...
    <body>
        <html:form action="actualizarHabUrba-action" method="post" >
            <table width="750" align="center" cellPadding="0" cellSpacing="0" class="clsTabla2">
                <tr>
                    <td class="Titulo1">ACTUALIZAR HABILITACI&Oacute;N URBANA</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                                ...
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="clsTabla2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String grupo_urba = (String)session.getAttribute("grupo_urba");
                                                    grupo_urba = grupo_urba==null? "": grupo_urba;
                                                %>
                                                <input type="text" class="casillaDatos" name="grupo_urba" id="grupo_urba" value="<%=grupo_urba%>" maxlength="30" onkeyup="this.value=this.value.toUpperCase();" onkeypress="return valida(this,'afn');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String cod_hab_urba = (String)session.getAttribute("cod_hab_urba");
                                                    cod_hab_urba = cod_hab_urba==null? "": cod_hab_urba;
                                                %>
                                                <input type="text" class="casillaNro" name="cod_hab_urba" id="cod_hab_urba" value="<%=cod_hab_urba%>" maxlength="4" onkeyup="this.value=this.value.toUpperCase();" onkeypress="return valida(this,'int');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String tip_hab_urba = (String)session.getAttribute("tip_hab_urba");
                                                    tip_hab_urba = tip_hab_urba==null? "": tip_hab_urba;
                                                %>
                                                <select class="clsComboLargo" name="tip_hab_urba">
                                                    ...
                                                    <%for(int i=0;i<listaTipoHabUrba.size();i++){%>
                                                        ...
                                                        <option <%if(codTipHabUrba.equals(tip_hab_urba)){%> selected <%}%> value="<%=codTipHabUrba%>">
                                                            <%=descripcion%>
                                                        </option>
                                                    <%}%>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                    String nom_hab_urba = (String)session.getAttribute("nom_hab_urba");
                                                    nom_hab_urba = nom_hab_urba==null? "": nom_hab_urba.trim();
                                                %>
                                                <input type="text" class="casillaLarga" name="nom_hab_urba" id="nom_hab_urba" value="<%=nom_hab_urba%>" maxlength="50" onkeyup="this.value=this.value.toUpperCase();" onkeypress="return valida(this,'afn');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                %>
                                                <input type="text" class="casillaNro" name="id_ubi_geo" id="id_ubi_geo" value="<%=id_ubi_geo%>" maxlength="6" onkeypress="return valida(this,'int');"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                        ...
                        <p align="center">
                            ...
                            <input class="buttoncenter" type="button" value="Eliminar" name="bEliminar" onclick="JavaScript:eliminarHabUrba();"/>
