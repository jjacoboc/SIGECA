            ...
            <td valign="middle">
                <html:form action="inicio-action" method="post">
                    ...
                    <table width="720" align="center" cellPadding="0" cellSpacing="0" class="clsTabla2">
                        <tr>
                            <td colspan="2" class="Titulo1">REPORTE DE LOTES CATASTRALES</td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            <td height="24" width="360" align="right">C&Oacute;DIGO DE REFERENCIA CATASTRAL&nbsp;&nbsp;&nbsp;</td>
                            <td>
                                <input type="text" class="casilla" name="codRefCatastral" onkeypress="return valida(this,'int');" size="24" maxlength="24"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <display:table name="sessionScope.listaFicha" defaultsort="1" export="true" pagesize="15" class="displaytag" id="row">
                                    ...
                                    <display:caption media="excel pdf">REPORTE DE LOTES CATASTRALES</display:caption>
                                    <display:column title="VER" media="html" style="text-align: center;width: 5%">
                                        <%
                                            ...
                                            String tipFicha = (String)((HashMap)listaFicha.get(indice)).get("codTipFicha");
                                        %>
                                    ...
                                    <display:column property="codRefCatastral" title="CÓDIGO DE REFERENCIA CATASTRAL" sortable="true" style="text-align: center;"/>
