 ...
 */
public class IdeTitCatastralHistDAO extends GenericDAO {

    /** Crea una nueva instancia de IdeTitCatastralHistDAO */
    public IdeTitCatastralHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarIdeTitCatastral(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codIdentificacion","TIDE_TIT_CATASTRAL_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TIDE_TIT_CATASTRAL_HIST(codIdentificacion,numFicha,codTipTitular,codEstCivil,codTipDocIdentidad,numDocIdentidad,");
            ...
            sql.append("numCotitular,numTotCotitular,porCotitular,codContribuyente,codForAdqTitular,fecAdqTitular,nomComercial,codConConductor,");
            sql.append("nomPredio,codFicha) ");
            ...
            pstm.setString(46,(String)map.get("codFicha"));
    ...
    public int actualizarIdeTitCatastral(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TIDE_TIT_CATASTRAL_HIST SET codTipTitular=?,codEstCivil=?,codTipDocIdentidad=?,numDocIdentidad=?,nombre=?,apePaterno=?,");
    ...
    public HashMap obtenerIdeTitCatastral(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("SELECT codIdentificacion,codTipTitular,codEstCivil,codTipDocIdentidad,numDocIdentidad,nombre,apePaterno,apeMaterno,numRuc,");
            sql.append("razSocial,codPerJuridica,codConEspTitular,numResExoneracion,numBolPensionista,date_format(fecIniExoneracion,'%d/%m/%Y'),");
            sql.append("date_format(fecVenExoneracion,'%d/%m/%Y'),codDepartamento,codProvincia,codDistrito,telefono,anexo,fax,corElectronico,codVia,");
            sql.append("codTipVia,nomVia,numMunicipal,nomEdificacion,numInterior,codHabUrbana,nomHabUrbana,sector,manzana,lote,sublote,numFicha,");
            sql.append("numCotitular,numTotCotitular,porCotitular,codContribuyente,codForAdqTitular,date_format(fecAdqTitular,'%d/%m/%Y'), ");
            sql.append("nomComercial,codConConductor,nomPredio ");
            sql.append("FROM TIDE_TIT_CATASTRAL_HIST ");
            ...
            if(rst.next()){
                titular = new HashMap();
                titular.put("codIdentificacion", rst.getString(1));
                ...
                titular.put("numRuc", rst.getString(9));
                titular.put("razSocial", rst.getString(10));
                titular.put("codPerJuridica", rst.getString(11));
                titular.put("codConEspTitular", rst.getString(12));
                titular.put("numResExoneracion", rst.getString(13));
                titular.put("numBolPensionista", rst.getString(14));
                titular.put("fecIniExoneracion", rst.getString(15));
                titular.put("fecVenExoneracion", rst.getString(16));
                titular.put("codDepartamento", rst.getString(17));
                titular.put("codProvincia", rst.getString(18));
                titular.put("codDistrito", rst.getString(19));
                titular.put("telefono", rst.getString(20));
                titular.put("anexo", rst.getString(21));
                titular.put("fax", rst.getString(22));
                titular.put("corElectronico", rst.getString(23));
                titular.put("codVia", rst.getString(24));
                titular.put("codTipVia", rst.getString(25));
                titular.put("nomVia", rst.getString(26));
                titular.put("numMunicipal", rst.getString(27));
                titular.put("nomEdificacion", rst.getString(28));
                titular.put("numInterior", rst.getString(29));
                titular.put("codHabUrbana", rst.getString(30));
                titular.put("nomHabUrbana", rst.getString(31));
                titular.put("sector", rst.getString(32));
                titular.put("manzana", rst.getString(33));
                titular.put("lote", rst.getString(34));
                titular.put("sublote", rst.getString(35));
