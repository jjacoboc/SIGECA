 ...
 */
public class ExplotacionHistDAO extends GenericDAO {

    /** Crea una nueva instancia de ExplotacionHistDAO */
    public ExplotacionHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarExplotacion(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codExplotacion","TEXPLOTACION_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TEXPLOTACION_HIST(codExplotacion,numFicha,desTemporal,porTemporal,desPermanente,porPermanente,");
    ...
    public int actualizarExplotacion(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TEXPLOTACION_HIST SET desTemporal=?,porTemporal=?,desPermanente=?,porPermanente=?,desForestal=?,porForestal=?,");
    ...
    public HashMap obtenerExplotacion(HashMap map) throws DAOException{
        ...
        try {
            ...
            sql.append("FROM TEXPLOTACION_HIST ");
