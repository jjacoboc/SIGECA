 ...
 */
public class NormaHistDAO extends GenericDAO {

    /** Crea una nueva instancia de NormaHistDAO */
    public NormaHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarNorma(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codNorLegal","TNOR_LEGAL_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TNOR_LEGAL_HIST(codNorLegal,codPredio,numNorma,fecNorma,numPlano) ");
    ...
    public long actualizarNorma(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TNOR_LEGAL_HIST SET numNorma=?,fecNorma=str_to_date(?,'%d/%m/%Y'),numPlano=? ");
    ...
    public int eliminarNorma(HashMap map) throws DAOException{
        ...
        try{
            StringBuffer sql = new StringBuffer();
            sql.append("DELETE FROM TNOR_LEGAL_HIST WHERE codNorLegal = ?");
    ...
    public List obtenerListaNorma(HashMap map) throws DAOException{
        ...
        try {
            ...
            sql.append("FROM TNOR_LEGAL_HIST ");
