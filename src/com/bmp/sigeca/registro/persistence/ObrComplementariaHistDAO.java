 ...
 */
public class ObrComplementariaHistDAO extends GenericDAO {

    /** Crea una nueva instancia de ObrComplementariaHistDAO */
    public ObrComplementariaHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarObraComplementaria(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codObrComplementaria","TOBR_COMPLEMENTARIA_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TOBR_COMPLEMENTARIA_HIST(codObrComplementaria,numFicha,codInstalacion,desInstalacion,fecConstruccion,");
            sql.append("codMEP,codECS,codECC,largo,ancho,alto,proTotal,uniMedida,codUCA,codFicha) ");
            ...
            pstm.setString(12,(String)map.get("proTotal"));
            pstm.setString(13,(String)map.get("uniMedida"));
            pstm.setString(14,(String)map.get("codUCA"));
            pstm.setString(15,(String)map.get("codFicha"));
    ...
    public long actualizarObraComplementaria(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TOBR_COMPLEMENTARIA_HIST SET codInstalacion=?,desInstalacion=?,fecConstruccion=str_to_date(?,'%d/%m/%Y'),");
            sql.append("codMEP=?,codECS=?,codECC=?,largo=?,ancho=?,alto=?,proTotal=?,uniMedida=?,codUCA=?,codFicha=? ");
            ...
            pstm.setString(10,(String)map.get("proTotal"));
            ...
            pstm.setString(14,(String)map.get("codObrComplementaria"));
    ...
    public int eliminarObraComplementaria(HashMap map) throws DAOException{
        ...
        try{
            StringBuffer sql = new StringBuffer();
            sql.append("DELETE FROM TOBR_COMPLEMENTARIA_HIST WHERE codObrComplementaria = ?");
    ...
    public List obtenerListaObraComplementaria(HashMap map) throws DAOException{
        ...
        try {
            ...
            sql.append("codMEP,codECS,codECC,largo,ancho,alto,proTotal,uniMedida,codUCA,codFicha ");
            sql.append("FROM TOBR_COMPLEMENTARIA_HIST ");
            ...
            while(rst.next()){
                ...
                obra.put("proTotal", rst.getString(12));
                obra.put("uniMedida", rst.getString(13));
                obra.put("codUCA", rst.getString(14));
                obra.put("codFicha", rst.getString(15));
                lista.add(obra);
            }
