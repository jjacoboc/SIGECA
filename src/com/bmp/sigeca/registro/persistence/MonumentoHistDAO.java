 ...
 */
public class MonumentoHistDAO extends GenericDAO {

    /** Crea una nueva instancia de MonumentoHistDAO */
    public MonumentoHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarMonumento(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codMonumento","TMONUMENTO_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TMONUMENTO_HIST(codMonumento,numFicha,codTipArqColonial,usoActual,usoOriginal,numPisos,fecConstruccion,areTerrTitulo,");
    ...
    public long actualizarMonumento(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TMONUMENTO_HIST SET codTipArqColonial=?,usoActual=?,usoOriginal=?,numPisos=?,fecConstruccion=str_to_date(?,'%d/%m/%Y %h:%i:%S'),");
    ...
    public HashMap obtenerMonumento(HashMap map) throws DAOException{
        ...
        try {
            ...
            sql.append("FROM TMONUMENTO_HIST ");
