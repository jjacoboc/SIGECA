 ...
 */
public class RecapitulacionHistDAO extends GenericDAO {

    /** Crea una nueva instancia de RecapitulacionHistDAO */
    public RecapitulacionHistDAO(TransactionContext context) {
        super(context);
    ...
    public long guardarRecapitulacion(HashMap map) throws DAOException{
        ...
        try {
            ...
            pk = (Long)tablaDAO.getNextPK("codRecapitulacion","TRECAPITULACION_HIST");

            StringBuffer sql = new StringBuffer();
            sql.append("INSERT INTO TRECAPITULACION_HIST(codRecapitulacion,numFicha,areTerInvLotColindante,areTerInvJarAislamiento,");
    ...
    public int actualizarRecapitulacion(HashMap map) throws DAOException{
        ...
        try {
            StringBuffer sql = new StringBuffer();
            sql.append("UPDATE TRECAPITULACION_HIST SET areTerInvLotColindante=?,areTerInvJarAislamiento=?,areTerInvArePublica=?,areTerInvAreIntangible=? ");
    ...
    public HashMap obtenerRecapitulacion(HashMap map) throws DAOException{
        ...
        try {
            ...
            sql.append("FROM TRECAPITULACION_HIST ");
